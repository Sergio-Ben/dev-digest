...
CREATE TABLE "skills" (
	...
	"attached_doc_paths" jsonb DEFAULT '[]'::jsonb NOT NULL,
...
CREATE TABLE "agents" (
	...
	"output_schema" jsonb,
	"strategy" text DEFAULT 'single-pass' NOT NULL,
	"ci_fail_on" text DEFAULT 'critical' NOT NULL,
	"repo_intel" boolean DEFAULT true NOT NULL,
	"attached_doc_paths" jsonb DEFAULT '[]'::jsonb NOT NULL,
	"enabled" boolean DEFAULT true NOT NULL,
	"version" integer DEFAULT 1 NOT NULL,
	"created_by" uuid,
...
CREATE UNIQUE INDEX "settings_ws_user_key_uq" ON "settings" USING btree ("workspace_id","user_id","key");--> statement-breakpoint
...
CREATE UNIQUE INDEX "symbols_repo_path_name_kind_line_uq" ON "symbols" USING btree ("repo_id","path","name","kind","line");--> statement-breakpoint
