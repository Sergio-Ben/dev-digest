...
export const evalRuns = pgTable(
  'eval_runs',
  {
    ...
    // Nullable: batches/versions are introduced as an additive grouping — older
    // rows (pre-batching) have no batch_id/agent_version. See T2 in
    // docs/plans/2026-08-26-agent-eval-pipeline.md.
